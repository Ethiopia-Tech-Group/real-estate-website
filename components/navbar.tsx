...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black backdrop-blur supports-[backdrop-filter]:bg-black border-b border-border text-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center space-x-2">
            ...
            {/* </div> */}
            <span className="font-bold text-gray-200 hidden sm:inline">Powered by ETG</span>
          </Link>
